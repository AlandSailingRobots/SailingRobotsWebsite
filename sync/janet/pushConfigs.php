...
class ASRService
{
    ...
    function __construct()
    {
        ...
        //$this->_db = new mysqli("localhost","ithaax_testdata","test123data","ithaax_testdata");
        //$this->_db = new mysqli("localhost","root","","ithaax_testdata");
    }
    ...
    function pushConfigs($data)
    {
        ...
        $course_calculationStmt = $this->_db->stmt_init();
        $maestro_controllerStmt = $this->_db->stmt_init();
        $rudder_commandStmt     = $this->_db->stmt_init();
        $rudder_servoStmt       = $this->_db->stmt_init();
        $sailing_robotStmt      = $this->_db->stmt_init();
        $sail_commandStmt       = $this->_db->stmt_init();
        $sail_servoStmt         = $this->_db->stmt_init();
        $waypoint_routingStmt   = $this->_db->stmt_init();
        $windsensorStmt         = $this->_db->stmt_init();
        $wind_vaneStmt          = $this->_db->stmt_init();
        $XbeeStmt               = $this->_db->stmt_init();
