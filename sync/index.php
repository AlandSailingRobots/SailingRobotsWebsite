        ...
        if ( isset($_POST['gen']) && $_POST['gen'] == 'aspire' )
        {
            ...
            if ( isset($_POST['id']) && isset($_POST['pwd']) )
            {
                if ( is_pwd_correct($_POST['pwd']) )
                {
                    ...
                    require_once('aspire/pushDataLogs.php');
                    require_once('aspire/getConfigs.php');
                    require_once('aspire/pushConfigs.php');
                    require_once('aspire/pushWaypoints.php');
                    require_once('aspire/getWaypoints.php');
