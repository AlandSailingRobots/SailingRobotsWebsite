...
<div class="modal fade" id="createPointModal" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-info myfooter convertGPSCoordinates" id="convertGPSCoordinatesNewPoint">Convert GPS Coordinates</button>
...
<!--                 <label class="col-md-4 control-label" for="isCheckpoint">Is Checkpoint ?</label>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-info myfooter convertGPSCoordinates" id="convertGPSCoordinatesEditPoint">Convert GPS Coordinates</button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success myfooter"  id="confirmGPSConverterButton">Convert GPS Coordinates</button>
        </div>
      </div>
    </div>
</div>
