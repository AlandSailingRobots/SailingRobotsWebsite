        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input id="newPointName" name="Name" placeholder="Mariehamn 1" class="form-control input-md"
                           required type="text">
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-md-6">
                        ...
                        <input type="number" class="form-control" id="newPointLatitude" name="" value=""
                               required="1"></input>
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <input type="number" class="form-control" id="newPointLongitude" name="longitude" value=""
                               required="1"></input>
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <input type="number" class="form-control" id="newPointRadius" name="radius" value=""
                               required="1"></input>
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <input type="number" class="form-control" id="newPointStay_time" name="stay_time" value=""
                               required="1"></input>
                    ...
                    <input type="number" class="form-control" id="newPointDeclination" name="declination" value="0"
                           required="1"></input>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-info myfooter convertGPSCoordinates"
                        id="convertGPSCoordinatesNewPoint">Convert GPS Coordinates
                </button>
                <button type="button" class="btn btn-primary myfooter" id="cancelNewPoint">Cancel</button>
                <button type="submit" class="btn btn-success myfooter" id="confirmNewPoint" onClick="createNewPoint();">
                    Create new <span class="waypointOrCheckpoint"><span></span></span></button>
            </div>
        </div>
    </div>
</div>
